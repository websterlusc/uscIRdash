...
def load_student_labour_data():
    ...
    try:
        ...
        if 'employment' in raw_data:
            ...
            print(f"📊 Employment years: {employment_df['Academic Year'].unique() if 'Academic Year' in employment_df.columns else 'No Academic Year column'}")
        ...
        if 'expense' in raw_data:
            ...
            print(f"📊 Expense years: {expense_df['Year'].unique() if 'Year' in expense_df.columns else 'No Year column'}")
