...
GOOGLE_CLIENT_ID = os.getenv('GOOGLE_CLIENT_ID', '890006312213-3k7f200g3a94je1j9trfjru716v3kidc.apps.googleusercontent.com')
...
def setup_auth_routes(app):
    ...
    def login_page():
        ...
        try:
            ...
            with open('login.html', 'r', encoding='utf-8') as f:
                ...
                html_content = html_content.replace('890006312213-3k7f200g3a94je1j9trfjru716v3kidc.apps.googleusercontent.com', GOOGLE_CLIENT_ID)
                return html_content
    ...
    print(
        f"✅ Google Client ID: {GOOGLE_CLIENT_ID[:20]}..." if GOOGLE_CLIENT_ID != '890006312213-3k7f200g3a94je1j9trfjru716v3kidc.apps.googleusercontent.com' else "⚠️ Google Client ID not configured")